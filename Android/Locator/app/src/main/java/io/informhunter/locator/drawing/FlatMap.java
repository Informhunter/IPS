...
public class FlatMap {
    ...
    public FlatMap(Bitmap mapBitmap, float xlength, float ylength) {
        ...
        currentPoint = new float[]{-5, -5};
        original = mapBitmap.copy(Bitmap.Config.ARGB_8888, true);
        xLength = xlength;
        yLength = ylength;
    }
    ...
    public void SetCurrentPoint(float loc[]) {
        currentPoint[0] = loc[0];
        currentPoint[1] = loc[1];
    }
